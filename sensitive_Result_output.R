...
label <- rep(c("NB","R0=0.01","R0=0.05","R0=0.1","R0=0.5"),16)
...
for (i in 1:16) {
  ...
  data_long$label <- factor(data_long$label, levels = c("NB","R0=0.01","R0=0.05","R0=0.1","R0=0.5"))
  data_long$variable <- factor(data_long$variable, levels = c("V2", "V3", "V4", "V5", "V6"), labels = c("Sub 1", "Sub 2", "Sub 3", "Sub 4", "Sub 5"))
  
  colors <- c("NB" = "#449945", "R0=0.01" = "#EA7827", "R0=0.05" = "#C22F2F", "R0=0.1" = "#83639F", "R0=0.5" = "#1F70A9")
