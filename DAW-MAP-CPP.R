...
DAW_MAP_CPP_results <- createWorkbook()
DAW_MAP_CPP_results_1 <- createWorkbook()
DAW_MAP_CPP_results_2 <- createWorkbook()
DAW_MAP_CPP_results_3 <- createWorkbook()
#Scenario 1
Scenario_1 <- DAW_MAP_CPP(trt.effect <- c(1.386294,1.386294,1.386294,1.386294,1.386294),
                       mu.cur <- c(0,0,0,0,0), 
...
#Scenario 2
Scenario_2 <- DAW_MAP_CPP(trt.effect <- c(0.9808293,0.9808293,0.9808293,0.9808293,0.9808293),
...
#Scenario 3
Scenario_3 <- DAW_MAP_CPP(trt.effect <- c(0.5389965,0.5389965,0.5389965,0.5389965,0.5389965),
...
#Scenario 5
Scenario_5 <- DAW_MAP_CPP(trt.effect <- c(0.9808293,0.8979416,0.8472979,0.8197099,0.8109302),
...
#Scenario 6
Scenario_6 <- DAW_MAP_CPP(trt.effect <- c(0.9808293,0.8472979,0.8109302,0.8472979,0.9808293),
...
writeData(DAW_MAP_CPP_results_2, sheet = "Sheet1", c(Scenario_5_results,Scenario_6_results,
                                                      Scenario_7_results,Scenario_8_results))
saveWorkbook(DAW_MAP_CPP_results_2, "DAW_MAP_CPP_2_output.xlsx", overwrite = TRUE)
##############################################################################################

#Scenario 9
Scenario_9 <- DAW_MAP_CPP(trt.effect <- c(0.9808293,0.9808293,0.9808293,0.9808293,0),
...
#Scenario 10
Scenario_10 <- DAW_MAP_CPP(trt.effect <- c(0.9808293,0.9808293,0.9808293,0,0),
...
#Scenario 11
Scenario_11 <- DAW_MAP_CPP(trt.effect <- c(0.9808293,0,0.8109302,0,0.9808293),
...
#Scenario 12
Scenario_12 <- DAW_MAP_CPP(trt.effect <- c(0.9808293,0,0.8472979,0,0.8109302),
...
writeData(DAW_MAP_CPP_results_3, sheet = "Sheet1", c(Scenario_9_results,Scenario_10_results,
                                                      Scenario_11_results,Scenario_12_results))
saveWorkbook(DAW_MAP_CPP_results_3, "DAW_MAP_CPP_3_output.xlsx", overwrite = TRUE)
##############################################################################################

#Scenario 13
Scenario_13 <- DAW_MAP_CPP(trt.effect <- c(0,0,0,0,0),
                            mu.cur <- c(0.1980421,0.1980421,0.1980421,0.1980421,0.1980421), 
...
#Scenario 14
Scenario_14 <- DAW_MAP_CPP(trt.effect <- c(0,0,0,0,0),
                            mu.cur <- c(0.1980421,0.1980421,0.1980421,0.1980421,0.1980421), 
...
#Scenario 15
Scenario_15 <- DAW_MAP_CPP(trt.effect <- c(0,0,0,0,0),
                            mu.cur <- c(0.1980421,0.1210426,0.05792359,0,-0.05792359),
...
#Scenario 16
Scenario_16 <- DAW_MAP_CPP(trt.effect <- c(0,0,0,0,0),
                            mu.cur <- c(0.1980421,0.1210426,0.05792359,0,-0.05792359), 
...
addWorksheet(DAW_MAP_CPP_results, "Sheet1")
writeData(DAW_MAP_CPP_results, "Sheet1", x = NULL)
writeData(DAW_MAP_CPP_results, sheet = "Sheet1", c(Scenario_1_results,Scenario_2_results,Scenario_3_results,
                                                ...
                                                Scenario_16_results))
saveWorkbook(DAW_MAP_CPP_results, "DAW_MAP_CPP_output.xlsx", overwrite = TRUE)
